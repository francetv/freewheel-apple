...
/**
	The timestamp of the start time of the break window. Must be an integer greater than zero. A breakSequence for a temporal slot configuration must also be set for this value to be added to the Ad Request. This property is only inteded for Comcast T6 integrations.
	See also `-[FWTemporalSlotConfiguration.breakSequence]`
 */
@property (nonatomic) NSUInteger windowStartTime;
