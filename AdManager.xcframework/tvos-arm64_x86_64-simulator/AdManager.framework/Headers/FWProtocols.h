 ...
 */
- (NSString *)getOMSDKLibraryVersion;
 ...
 */
- (NSString *)getOMSDKPartnerVersion;
...
#if TARGET_OS_TV
/**
 Notifies OMSDK to update last activity time when users interact on CTV devices. Per IAB, A specified list of event types which are acceptable to trigger the “last activity" signal are not included, as these interactions may vary by app. This may include interactions  such as “watch next,” “are you still watching,” “skip,” or others. The integrator may include as many signals as desired. This method will not have any effect before FWOMSDKExtension is initiated.
 */
...
/**
    Get deal id of the ad instance if the ad is delivered via deal, otherwise it will be an empty String. This property is readonly.

    @return a NSString value of the deal id of the ad instance
 */
- (NSString *)dealId;

/**
    Get the open exchange id of the ad instance if the ad is delivered via the Open Exchange rule, otherwise it will be an empty String. This property is readonly.

    @return a NSString value of the open exchange id of the ad instance
 */
- (NSString *)openExchangeId;

/**
    Get the market unified ad id of the ad instance if the ad is delivered via deal or the Open Exchange rule, otherwise it will be an empty String. This property is readonly.

    @return a NSString value of the market unified ad id of the ad instance
 */
- (NSString *)marketUnifiedAdId;

/**
	Get the action of the ad instance.

	@return a NSString value of the action of the ad instance, and empty string if the ad instance doesn't contain action string.
 */
- (NSString *)action;
...
/**
	Get the sold as ad unit value of an ad instance.

	@return Sold as ad unit value of an ad instance.
 */
- (NSString *)soAdUnit;
