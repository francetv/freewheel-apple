...
#import "FWGPPCMPAPIConsentConfiguration.h"
...
/**
 Used for holding GPP CMP API consent configuration information.

 Note:
    - FWConsentConfiguration will automatically set gppcmpapiConsentConfiguration from [NSUserDefaults standardUserDefaults].
 ...
 */
@property (nullable, nonatomic, readonly) FWGPPCMPAPIConsentConfiguration *gppcmpapiConsentConfiguration;
